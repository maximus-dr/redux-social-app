// A client-side server to develop, test and prototype JavaScript app.
import {
  Server,
  Model,
  Factory,
...
//Generates a non-cryptographically-secure random ID string
import { nanoid } from '@reduxjs/toolkit';

// generate massive amounts of fake data in the browser
import faker from 'faker';

// generaties random sentences, paragraphs and articles in English
